...
const spitOutFaren = (kelvin) => {
    celsius = Math.round(kelvin - 273.15);
    faren = Math.round(celsius * 9 / 5 + 32);
    return faren;
}
...
updateWeatherApp = (city) => {
    ...
    <div class="card-mid row">
            <div class="col-8 text-center temp">
              <span>${spitOutFaren(city.main.temp)}&deg;F</span>
            </div>
            <div class="col-4 condition-temp">
              <p class="condition">${city.weather[0].description}</p>
              <p class="high">${spitOutFaren(city.main.temp_max)}&deg;F</p>
              <p class="low">${spitOutFaren(city.main.temp_min)}&deg;F</p>
            </div>
          </div>
          ...
          <div class="card-bottom px-5 py-4 row">
            <div class="col text-center">
              <p>${spitOutFaren(city.main.feels_like)}&deg;F</p>
